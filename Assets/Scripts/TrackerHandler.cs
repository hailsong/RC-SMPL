...
public class TrackerHandler : MonoBehaviour
{
    ...
    public byte[] getImageData(BackgroundData trackerFrameData)
    {
        return trackerFrameData.DepthImage;
    }

    //public Capture getCaptureData(BackgroundData trackerFrameData)
    //{
    //    return trackerFrameData.Bodyframecapture;
    //}

    public Vector3[] getVerticesData(BackgroundData trackerFrameData)
    {
        return trackerFrameData.vertices;
    }
    public Color32[] getColorsData(BackgroundData trackerFrameData)
    {
        return trackerFrameData.colors;
    }

    public int[] getIndicesData(BackgroundData trackerFrameData)
    {
        return trackerFrameData.indices;
    }

    public Image getColorImg(BackgroundData trackerFrameData)
    {
